        ...
        <div className="grid lg:grid-cols-2 gap-12 max-w-5xl mx-auto">
          ...
          >
            ...
            <div className="space-y-6">
              <a
                href="mailto:ramreddyseelam1@gmail.com"
              ...
              >
                ...
                <div>
                  ...
                  <p className="font-medium group-hover:text-primary transition-colors">ramreddyseelam1@gmail.com</p>
                </div>
              </a>
              ...
              >
                ...
                <div>
                  ...
                  <p className="font-medium group-hover:text-primary transition-colors">+1 206-491 6443</p>
                </div>
              </a> */}
