      ...
      <div className="section-container relative z-10 flex flex-col-reverse lg:flex-row items-center justify-between gap-12">
        ...
        <div className="flex-1 flex flex-col items-center lg:items-start text-center lg:text-left">
          ...
          >
            ...
            <h1 className="font-display text-2xl sm:text-3xl md:text-3xl lg:text-3xl font-bold mb-3">
              Venkata Ramireddy <span className="gradient-text">Seelam</span>
            </h1>
          </motion.div>
          ...
          >
            <a href="https://github.com/Ramreddy2748" target="_blank" rel="noopener noreferrer" className="social-icon">
              <Github size={20} />
            </a>
            <a href="https://www.linkedin.com/in/venkata-ramireddy/" target="_blank" rel="noopener noreferrer" className="social-icon">
              <Linkedin size={20} />
            </a>
            <a href="mailto:ramreddyseelam1@gmail.com" className="social-icon">
              <Mail size={20} />
            </a>
          </motion.div>
          ...
          >
            ...
            <a href="/Venkata_Ramireddy_Seelam_Resume.pdf"
              download="Venkata_Ramireddy_Seelam_Resume.pdf"
